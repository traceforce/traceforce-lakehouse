...
Device owner from your MDM. The attribution path for agents whose logs carry no email (Copilot, Vertex-authenticated Claude Code).
...
| `owner_email` | string | Owner email from the MDM. |
