...
| `risky_action_category` | string | Rule-19 grouping of the risky action, as text: 'company_data_or_infra_destroyed' / 'company_systems_changed' / 'device_defenses_disabled_or_wiped' / 'device_or_dev_env_changed'; 'unknown' on rows from older scouts (no taxonomy). Derived from risky_action_subcategory. |
