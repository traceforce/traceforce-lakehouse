...
| `resource_type` | string | Sensitivity class of what servers in this category reach, as text ('public' / 'internal_apps' / 'dev_tools' / 'database_infrastructure' / 'local_system'). |
