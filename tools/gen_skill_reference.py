...
COMMON = {
    ...
    "metadata": "JSON text. On the findings tables: reviewer close tracking {statusComment, statusUpdatedAt, statusUpdatedBy}, empty or NULL until a reviewer closes the finding; elsewhere vendor-specific extras (e.g. version).",
