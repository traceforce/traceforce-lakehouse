...
TABLES = {
    ...
    "mcp_server_instances": dict(
        ...
        notes={"metadata": "JSON text; detection details for filesystem MCPs: matched_pattern, auth_matched_pattern, config_type, uid, version, agent_identity, agent_deployment.",
